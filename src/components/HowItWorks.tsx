...
const HowItWorks = () => {
  ...
  return <section ref={sectionRef} id="how-it-works" className="py-28 md:py-40 bg-background">
            ...
            return <motion.div key={index} initial={{
              ...
              delay: index * 0.15
                ...
                y: ghostY
                  ...
                  {index < steps.length - 1 && <div className="absolute top-1/2 -right-4 lg:-right-6 w-8 lg:w-12 h-px bg-border hidden lg:block" />}
                </motion.div>;
          })}
          </div>
