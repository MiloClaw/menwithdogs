  ...
  return <section className="py-24 md:py-32 bg-background border-t border-border">
      <div className="container max-w-2xl">
        ...
        <div className="text-center mb-16 md:mb-20">
          <p className="font-serif text-xl md:text-2xl text-foreground font-medium leading-relaxed mb-6">Most apps keep you online.
We're built to help you show up 
in the real world, on your terms.
          ...
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed mt-6">No pressure. No algorithms chasing engagement.
