...
const values = [
  ...
  },
  {
    icon: Users,
    title: "Community",
    description: "Built by couples, for couples. Every recommendation comes from people who understand.",
  },
  {
    icon: Shield,
    title: "Privacy",
    description: "Your relationship is yours. We don't share your data or sell your information.",
  },
  {
    icon: Compass,
    title: "Intention",
      ...
      <div className="container py-8 md:py-12 lg:py-16">
        ...
        <div className="max-w-prose mb-12 md:mb-16">
          <p className="text-base md:text-lg text-muted-foreground leading-relaxed mb-6">
            ...
            from the screen and into the world—together. We're building a platform that helps 
            couples discover the hidden gems in their own neighborhoods, the kind of places 
            that become part of your story.
          </p>
          <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
            This isn't about optimizing your relationship or gamifying date nights. It's about 
        ...
        <section className="mb-12 md:mb-16">
          ...
          <div className="max-w-prose">
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-4">
              MainStreetIRL is a discovery platform for couples who want to explore their local 
              communities. We curate recommendations for couple-friendly spaces—places where you 
              can actually have a conversation, share an experience, or simply enjoy being together.
            </p>
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-4">
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
              ...
              and every suggestion comes from real couples who've been there.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12 md:mb-16 py-8 md:py-12 px-6 md:px-8 bg-surface rounded-card">
          ...
          <div className="max-w-prose">
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-4">
              We're not here to help you find a partner—we're here to help you and your partner 
              find great places to spend time together. MainStreetIRL is for couples who are 
              already in relationships, whether you've been together for two months or twenty years.
            </p>
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <div className="max-w-prose">
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-4">
              We envision a world where couples spend less time scrolling through generic 
              recommendations and more time creating memories in places that actually matter to them.
            </p>
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-4">
              Our goal is to become the trusted guide for couples who want to discover their 
              communities—one neighborhood, one hidden gem, one shared experience at a time.
            </p>
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
