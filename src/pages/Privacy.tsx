        ...
        <div className="max-w-prose">
          <section className="mb-8 md:mb-12">
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-4">
              Men With Dogs ("we," "us," or "our") is committed to protecting your privacy. This 
              Privacy Policy explains how we collect, use, disclose, and safeguard your information 
              when you use our Service.
            </p>
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
              By accessing or using Men With Dogs, you agree to the terms of this Privacy Policy. 
          ...
          <section className="mb-8 md:mb-12">
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed mb-4">
              Men With Dogs is designed around intentional privacy. We believe meaningful community 
          ...
          <section className="mb-8 md:mb-12">
            ...
            <ul className="list-disc list-inside text-sm md:text-base text-muted-foreground leading-relaxed space-y-2 ml-4">
              ...
              <li><strong className="text-foreground">Safety and protection:</strong> To protect the rights, safety, or property of Men With Dogs, our users, or the public</li>
          ...
          <section className="mb-8 md:mb-12">
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
              To exercise these rights, please contact us at privacy@menwithdogs.com. We will 
          ...
          <section className="mb-8 md:mb-12">
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
              Men With Dogs is intended for users 18 years of age and older. We do not knowingly 
          ...
          <section>
            ...
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
              ...
              contact us at privacy@menwithdogs.com.
            </p>
          </section>
        </div>
      </div>
