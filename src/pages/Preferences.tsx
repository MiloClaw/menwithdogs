...
/**
 * Preferences page - optional settings for tailoring place discovery.
 * 
 * Not a "profile" in the social sense. Just a settings page.
 * "These help us show you better places."
 */
const Preferences = () => {
  ...
  const [cityInput, setCityInput] = useState(memberProfile?.city || '');
  ...
  return (
    <PageLayout>
      <div className="container py-8 md:py-12 max-w-2xl space-y-8">
        {/* Header */}
